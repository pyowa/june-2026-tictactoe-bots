...
- [ ] **`runner/dispatch.py:MATCH_TIMEOUT`** — `MATCH_TIMEOUT = float(os.environ.get("MATCH_TIMEOUT", "120"))`. Both the env-var name and the `"120"` default can be mutated. Fix: assert default is 120.0 with the env unset.
